import {Codec, struct, u64, ref, bool, option, address, array, string, u16, u8, binary, fixedArray, hashMap, sum, unit, tuple} from '@subsquid/borsh'
...
export type CollectionToggle_Set = [
    Collection,
]

export const CollectionToggle_Set = tuple([
    ref(() => Collection),
])
...
export type UsesToggle_Set = [
    Uses,
]

export const UsesToggle_Set = tuple([
    ref(() => Uses),
])
...
export type CollectionDetailsToggle_Set = [
    CollectionDetails,
]

export const CollectionDetailsToggle_Set = tuple([
...
export type RuleSetToggle_Set = [
    string,
]

export const RuleSetToggle_Set = tuple([
    address,
])
...
export type EscrowAuthority_Creator = [
    string,
]

export const EscrowAuthority_Creator = tuple([
    address,
])
...
export type PrintSupply_Limited = [
    bigint,
]

export const PrintSupply_Limited = tuple([
    u64,
])
...
export type PayloadType_Pubkey = [
    string,
]

export const PayloadType_Pubkey = tuple([
    address,
])

export type PayloadType_Seeds = [
    SeedsVec,
]

export const PayloadType_Seeds = tuple([
    ref(() => SeedsVec),
])

export type PayloadType_MerkleProof = [
    LeafInfo,
]

export const PayloadType_MerkleProof = tuple([
    ref(() => LeafInfo),
])

export type PayloadType_Number = [
    bigint,
]

export const PayloadType_Number = tuple([
    u64,
])
